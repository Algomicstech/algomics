  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden hero-gradient">
          ...
          <>
            <div
              ...
              style={{
                ...
                backgroundSize: isAtacSeq ? "75% auto" : isRnaSeq ? "80% auto" : isChipSeq ? "75% auto" : "cover",
                backgroundPosition: isAtacSeq ? "right 70%" : isRnaSeq ? "right 80%" : isChipSeq ? "right 80%" : "right 90%",
              }}
              aria-hidden="true"
            />
        ...
        {!customHeroBg && <AbstractShapes variant="hero" />}
